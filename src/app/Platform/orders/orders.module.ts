...
@NgModule({
  declarations: [AmazonOrdersListingComponent,AmazonOrderDetails, EbayOrdersListingComponent, WalmartOrdersListingComponent, AddOrderComponent, OrderListingComponent, ViewOrderComponent],
  imports: [
    CommonModule,
